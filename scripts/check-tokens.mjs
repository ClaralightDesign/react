...
const RUNTIME = new Set([
  ...
  // The progress bar's geometry, all of it state rather than design values:
  // the determinate fraction, the four edges the indeterminate cycle animates,
  // and the per-segment range each segment is positioned from.
  "--cl-progress-value",
  "--cl-progress-head-1",
  "--cl-progress-tail-1",
  "--cl-progress-head-2",
  ...
  "--cl-progress-near",
  "--cl-progress-far",
  // The ring's, on the same footing: the size class picks a radius and a cap,
  // everything else is derived from those two, and three of them are the edges
  // its indeterminate cycle animates.
  "--cl-progress-ring-radius",
  "--cl-progress-ring-cap",
  "--cl-progress-ring-stroke",
  "--cl-progress-ring-box",
  "--cl-progress-ring-length",
  "--cl-progress-ring-gap",
  "--cl-progress-ring-arc",
  "--cl-progress-ring-rotation",
  "--cl-progress-ring-step",
  "--cl-progress-fraction",
  "--cl-progress-dash",
  "--cl-progress-start",
  "--cl-progress-indicator-arc",
